...
class AzureTTS:
    def __init__(self):
        ...
        self.output_format = os.environ.get('AZURE_SPEECH_OUTPUT_FORMAT', 'riff-24khz-16bit-mono-pcm')
    ...
    def synthesize(self, text):
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to synthesize speech: {response.status_code} - {response.reason}")
            return None